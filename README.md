...
- [Configuration as Code for Ansible Automation Platform](#configuration-as-code-for-ansible-automation-platform)
  ...
  - [Exporting content from AAP](#exporting-content-from-aap)
    - [AAP 2.4](#aap-24)
  - [Migrating AAP Configurations Between Versions (2.4 to 2.5/2.6)](#migrating-aap-configurations-between-versions-24-to-2526)
    - [Migration Strategy: Flatten vs Filetree](#migration-strategy-flatten-vs-filetree)
    - [Known Issues in AAP 2.4 to 2.5/2.6 Migration](#known-issues-in-aap-24-to-2526-migration)
      - [Issue 1: Variable Name Changes](#issue-1-variable-name-changes)
      - [Issue 2: Malformed YAML in Exported Data](#issue-2-malformed-yaml-in-exported-data)
      - [Issue 3: Instance Groups Don't Migrate](#issue-3-instance-groups-dont-migrate)
    - [Recommended Migration Workflow](#recommended-migration-workflow)
      - [Phase 1: Export from AAP 2.4](#phase-1-export-from-aap-24)
      - [Phase 2: Transform Exported Data](#phase-2-transform-exported-data)
      - [Phase 3: Multi-Stage Import to AAP 2.5/2.6](#phase-3-multi-stage-import-to-aap-2526)
      - [Phase 4: Recreate Instance Groups](#phase-4-recreate-instance-groups)
    - [Migration Verification Checklist](#migration-verification-checklist)
    - [Troubleshooting Migration Issues](#troubleshooting-migration-issues)
    - [Post-Migration: Transition to Filetree for Ongoing CaC](#post-migration-transition-to-filetree-for-ongoing-cac)
